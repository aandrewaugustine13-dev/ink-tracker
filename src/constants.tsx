...
{ id: 'erotic-realism', name: 'Photorealistic Intimate', prompt: 'ultra photorealistic sensual erotic portrait, detailed realistic skin texture and anatomy, soft intimate lighting, cinematic chiaroscuro, tasteful artistic sensual pose, high detail masterpiece, no cartoon elements' },
